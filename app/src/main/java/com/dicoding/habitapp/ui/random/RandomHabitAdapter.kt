...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val pagerTitle: TextView = itemView.findViewById(R.id.pager_tv_title)
        private val pagerStartTime: TextView = itemView.findViewById(R.id.pager_tv_start_time)
        private val pagerPriorityLevel : ImageView = itemView.findViewById(R.id.pager_priority_level)
        private val pagerMinute : TextView = itemView.findViewById(R.id.pager_tv_minutes)
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            pagerMinute.text = pageData.minutesFocus.toString()
            when (pageType) {
                ...
                PageType.LOW -> pagerPriorityLevel.setImageResource(R.drawable.ic_priority_low)
            }
